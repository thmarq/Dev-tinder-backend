...
const validateEditProfile = (req) => {
    const allowedEditFields = ['firstName', 'age', 'lastName','gender', 'about', 'skills', 'photoUrl']
    const isEdit = Object.keys(req.body).every((input)=>  allowedEditFields.includes(input))
    if(!isEdit){
...
module.exports = {signUpValidator, loginValidator, validateEditProfile, validateChangePassword};